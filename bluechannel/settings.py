...
DATABASE_NAME = 'merwin_prod'             # Or path to database file if using sqlite3.
DATABASE_USER = 'merwin_prod'             # Not used with sqlite3.
DATABASE_PASSWORD = '37387ef1'         # Not used with sqlite3.
